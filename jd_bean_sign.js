...
async function execSign() {
  ...
  try {
    ...
    console.error(`[表情][表情][表情][表情][表情][表情][表情][表情][表情][表情][表情]签到详情[表情][表情][表情][表情][表情][表情][表情][表情][表情][表情][表情]\n${notifyContent}\n[表情][表情][表情][表情][表情][表情][表情][表情][表情]签到详情[表情][表情][表情][表情][表情][表情][表情][表情][表情][表情][表情]`);
